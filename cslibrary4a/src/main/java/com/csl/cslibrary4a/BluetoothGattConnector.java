...
public class BluetoothGattConnector extends BluetoothGattCallback {
    ...
    private Context mContext; TextView mLogView; private Activity activity; String strReaderServiceUUID;
    public BluetoothGattConnector(Context context, TextView mLogView, String strReaderServiceUUID, Utility utility) {
        boolean DEBUG = false;
