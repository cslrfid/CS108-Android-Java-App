...
public class SettingData {
    ...
    boolean loadSettingFile(String stringMacAddress, String strlibraryVersion, boolean bChannelHoppingStatus, int iCurrentProfile) {
            ...
            if (instream != null) {
                ...
                while(true) {
                    ...
                    if (dataArray.length == 2) {
                        if (dataArray[0].matches("appVersion")) {
                        ...
                        } else if (dataArray[0].matches("antennaPort")) {
                            int iValue = Integer.valueOf(dataArray[1]);
                            if (iValue >= 0) csReaderConnector.rfidReader.setAntennaSelect(iValue);
                        } else if (dataArray[0].matches("antennaEnable")) {
                            int iValue = Integer.valueOf(dataArray[1]);
                            if (false) appendToLog("SettingData.loadSettingFile: old antennaEnable = " + csReaderConnector.rfidReader.getAntennaEnable() + ", new antennaEnable = " + iValue);
                            if (iValue == 0 || iValue == 1) csReaderConnector.rfidReader.setAntennaEnable(iValue > 0);
                            ...
                            long lValue = Long.valueOf(dataArray[1]);
                            if (lValue >= 0) csReaderConnector.rfidReader.setAntennaDwell(lValue);
                            ...
                            int iValue = Integer.valueOf(dataArray[1]);
                            if (iValue >= 0) csReaderConnector.rfidReader.setTagFocus(iValue > 0);
                        } else if (dataArray[0].matches("fastId")) {
                            int iValue = Integer.valueOf(dataArray[1]);
                            if (iValue >= 0) csReaderConnector.rfidReader.setFastId(iValue > 0);
                        ...
                        } else if (dataArray[0].matches("powerBoost")) {
                            int iValue = Integer.valueOf(dataArray[1]);
                            if (false) appendToLog("SettingData.loadSettingFile: old powerBoost = " + csReaderConnector.rfidReader.getPowerBoost() + ", new powerBoost = " + iValue);
                            if (iValue >= 0) csReaderConnector.rfidReader.setPowerBoost(iValue > 0);
                        ...
                        if (dataArray[0].matches("querySession")) {
                            int iValue = Integer.valueOf(dataArray[1]);
                            int iValue1 = Integer.valueOf(dataArray[2]);
                            if (iValue >= 0) querySession = iValue;
                            if (iValue1 >= 0) queryTarget = iValue1;
                            appendToLog("FileA: querySession = " + querySession + ", queryTarget = " + queryTarget);
                ...
                csReaderConnector.rfidReader.setTagFocus(csReaderConnector.rfidReader.getTagFocus() > 0);
        ...
        if (bNeedDefault) {
            ...
            int iValue = csReaderConnector.bluetoothConnector.getCsModel();
            if (iValue == 203) iValue = 2; else iValue = 1;
            for (int i = 0; i < iValue; i++) {
                csReaderConnector.rfidReader.setAntennaSelect(i);
    ...
    public void saveSetting2File(String strLibraryVersion, boolean bChannelHoppingStatus, int iCurrentProfile) {
        ...
        try {
            ...
            int iCsModel = csReaderConnector.bluetoothConnector.getCsModel();
            int iPortCount = 1;
            if (iCsModel == 203) iPortCount = 2;
            for (int i = iPortCount - 1; i >= 0; i--) {
                write2FileStream(stream, "antennaPort," + String.valueOf(csReaderConnector.rfidReader.antennas[i].port + "\n"));
                write2FileStream(stream, "antennaEnable," + String.valueOf(csReaderConnector.rfidReader.antennas[i].getAntennaEnable() + "\n"));
                write2FileStream(stream, "antennaPower," + String.valueOf(csReaderConnector.rfidReader.antennas[i].getPwrlevel() + "\n"));
                write2FileStream(stream, "antennaDwell," + String.valueOf(csReaderConnector.rfidReader.antennas[i].getAntennaDwell() + "\n"));
                write2FileStream(stream, "population," + String.valueOf(csReaderConnector.rfidReader.antennas[i].getPopulation() + "\n"));
                write2FileStream(stream, "invAlgo," + String.valueOf(csReaderConnector.rfidReader.antennas[i].getInvAlgo() + "\n"));
                write2FileStream(stream, "querySession," + String.valueOf(csReaderConnector.rfidReader.antennas[i].getQuerySession() + "," +  String.valueOf(csReaderConnector.rfidReader.antennas[i].getQueryTarget()) + "\n"));
                write2FileStream(stream, "tagFocus," + String.valueOf(csReaderConnector.rfidReader.antennas[i].getTagFocus() + "\n"));
                write2FileStream(stream, "fastId," + String.valueOf(csReaderConnector.rfidReader.antennas[i].getFastId() + "\n"));
                write2FileStream(stream, "currentProfile," + String.valueOf(csReaderConnector.rfidReader.antennas[i].getCurrentProfile() + "\n"));
            }
            write2FileStream(stream, "powerBoost," + String.valueOf(csReaderConnector.rfidReader.getPowerBoost() + "\n"));
