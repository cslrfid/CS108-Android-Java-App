...
public class SettingOperateFragment extends CommonFragment {
    ...
    private final Runnable updateRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (MainActivity.mCs108Library4a.mrfidToWriteSize() != 0)   {
                updating = true; MainActivity.mCs108Library4a.appendToLog("upating 1");
            }
            else {
                iPopulation = MainActivity.mCs108Library4a.getPopulation();
                if (iPopulation < 0) {
                    updating = true; MainActivity.mCs108Library4a.appendToLog("upating 2");
                }
                else {
                ...
                if (updating == false) {
                    ...
                    if (channel < 0) {
                        updating = true; MainActivity.mCs108Library4a.appendToLog("upating 3");
                    }
                ...
                if (updating == false && textViewPortChannel != null) {
                    ...
                    if (lValue < 0) {
                        updating = true; MainActivity.mCs108Library4a.appendToLog("upating 4");
                    } else {
                ...
                if (updating == false) {
                    ...
                    if (lValue < 0) {
                        updating = true; MainActivity.mCs108Library4a.appendToLog("upating 5");
                    } else {
                ...
                if (updating == false && editTextPortDwell != null) {
                    ...
                    if (lValue < 0) {
                        updating = true; MainActivity.mCs108Library4a.appendToLog("upating 6");
                    } else {
                ...
                if (updating == false) {
                    ...
                    if (iValue < 0) {
                        updating = true; MainActivity.mCs108Library4a.appendToLog("upating 7");
                    } else {
                ...
                if (updating == false) {
                    ...
                    if (iValue < 0) {
                        updating = true; MainActivity.mCs108Library4a.appendToLog("upating 8");
                    }
                    else {
                ...
                if (updating == false) {
                    ...
                    if (iRetry < 0) {
                        updating = true; MainActivity.mCs108Library4a.appendToLog("upating 9");
                    }
                    else editTextRetry.setText(String.valueOf(iRetry));
                }
                if (updating == false) {
                    String[] strCountryList = MainActivity.mCs108Library4a.getCountryList();
                    for (int i = 0; i < strCountryList.length; i++) MainActivity.mCs108Library4a.appendToLog("upating: String " + i + " = " + strCountryList[i]);
                    if (strCountryList == null) {
                        updating = true; MainActivity.mCs108Library4a.appendToLog("upating 10");
                    } else
                    if (true) {
                        ...
                        MainActivity.mCs108Library4a.appendToLog("upating countryNumber = " + countryNumber);
            ...
            if (updating == false) {
                ...
                if (iValue < 0) {
                    updating = true; MainActivity.mCs108Library4a.appendToLog("upating 11");
                } else {
            ...
            if (updating == false) {
                ...
                if (strRssi == null) {
                    updating = true; MainActivity.mCs108Library4a.appendToLog("upating 12");
                }
            ...
            if (updating == false) {
                ...
                if (iValue < 0) {
                    updating = true; MainActivity.mCs108Library4a.appendToLog("upating 13");
                } else checkBoxHighCompression.setChecked(iValue == 0 ? false : true);
            }
            if (updating == false) {
                iValue = MainActivity.mCs108Library4a.getRflnaGain();
                if (iValue < 0) {
                    updating = true; MainActivity.mCs108Library4a.appendToLog("upating 14");
                } else {
                    switch (iValue) {
                        case 2:
                            iValue = 1;
            ...
            if (updating == false) {
                ...
                if (iValue < 0) {
                    updating = true; MainActivity.mCs108Library4a.appendToLog("upating 15");
                } else {
                    switch (iValue) {
                        case 1:
                            iValue = 1;
            ...
            if (updating == false) {
                ...
                if (iValue < 0) {
                    updating = true; MainActivity.mCs108Library4a.appendToLog("upating 16");
                } else {
                    switch (iValue) {
                        case 4:
                            iValue = 1;
    ...
    void settingUpdate() {
        ...
        if (invalidRequest == false && (MainActivity.mCs108Library4a.getCountryNumberInList() != countrySelect || sameCheck == false)) {
            sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 1");
        ...
        if (invalidRequest == false && (MainActivity.mCs108Library4a.getChannelHoppingStatus() != (channelOrder == 0 ? true : false) || sameCheck == false)) {
            sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 2");
        ...
        if (invalidRequest == false && (MainActivity.mCs108Library4a.getChannel() != channelSelect || sameCheck == false)) {
            sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 3");
        ...
        if (false && invalidRequest == false && (MainActivity.mCs108Library4a.getAntennaSelect() + 1 != channel  || sameCheck == false)) {
            sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 4");
        ...
        if (invalidRequest == false && (MainActivity.mCs108Library4a.getAntennaEnable() != portEnable || sameCheck == false || changedChannel)) {
            sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 5");
        ...
        if (invalidRequest == false && (MainActivity.mCs108Library4a.getPwrlevel() != powerLevel || sameCheck == false)) {
            sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 6");
        ...
        if ((invalidRequest == false && (MainActivity.mCs108Library4a.getAntennaDwell() != dwellTime || sameCheck == false || changedChannel))) {
            sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 7");
        ...
        if ((invalidRequest == false && editTextTagDelay != null)) {
            if (MainActivity.mCs108Library4a.getTagDelay() != byteTagDelay || sameCheck == false) {
                sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 8");
        ...
        if (overriding) {
            if (MainActivity.mCs108Library4a.getQValue() != byteFixedQValue || sameCheck == false) {
                sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 9");
            ...
            if (invalidRequest == false && (MainActivity.mCs108Library4a.getPopulation() != iPopulation || MainActivity.mCs108Library4a.getQValue() != byteFixedQValue || sameCheck == false)) {
                sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 10");
        ...
        if ((MainActivity.mCs108Library4a.getQueryTarget() != queryTarget
            ...
            sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 11");
        ...
        if (MainActivity.mCs108Library4a.getTagFocus() != tagFocus || sameCheck == false) {
            sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 12");
        ...
        if (invalidRequest == false) {
            if (MainActivity.mCs108Library4a.getInvAlgo() != invAlgoDynamic || sameCheck == false) {
                sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 13");
        ...
        if (invalidRequest == false) {
            if (MainActivity.mCs108Library4a.getRetryCount() != retry || sameCheck == false) {
                sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 14");
        ...
        if (invalidRequest == false) {
            if (MainActivity.mCs108Library4a.getCurrentProfile() != profile || sameCheck == false) {
                sameSetting = false; MainActivity.mCs108Library4a.appendToLog("point 15");
